...
class receiver(object):
    ...
    def handle_client(self):
        Receiver = socket.socket(socket.AF_INET, socket.SOCK_STREAM) # create socket and defind the family and type of socket 
        Receiver.connect((self.Host, self.Port))  # socket with ip address and port number 
        
        connection = True

        while connection:
            msg = Receiver.recv(512)
